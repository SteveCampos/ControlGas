package gas.apps.steve.controlgas.bluetooth;
...
public class BluetoothService {
    ...
    public synchronized void start(boolean isAndroid) {
        ...
        if (mSecureAcceptThread == null) {
            mSecureAcceptThread = new BluetoothService.AcceptThread(isAndroid);
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        mConnectedThread = new BluetoothService.ConnectedThread(socket, socketType);
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    Log.d(TAG, "mmInStream.read(): " + data);
                    arr_byte.add(data);

                    if (((Integer) data).byteValue() == 3){
